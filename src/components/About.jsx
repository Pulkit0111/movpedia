  ...
  return (
    <div>
      <p>
        ...
        present to you a small project of mine MOVIE_WORM, be it a movie or a tv
        series that you want to binge, just visit here and look for the desired
        content and you get all the details related to the flick you want to
        enjoy, that will help you decide based on the IMDB and ROTTEN TOMATOES
        ratings.
      </p>
